...
/* -------------------------------------------------------------------
  ...
  |
  ------------------------------------------------------------------- */
//la cagada de dirnames te deja en Util\
//TODO: cambiar escribite OJO
$config['upload_path'] = dirname(dirname(dirname(dirname(dirname(__FILE__))))) . DIRECTORY_SEPARATOR . 'escribite' . DIRECTORY_SEPARATOR . $config['img_path'];
?>
