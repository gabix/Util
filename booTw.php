...
<html>
    ...
    <body>
        <div class="container-fluid">
            <div class="row-fluid">
                <div id="barra" class="span2 well well-small">
                ...
                <div id="conte" class="span10 well">
                    <h1><?= $pagTitle ?></h1>
                    <hr />
                    <div id="sel">
                    </div>
        ...
        <script type="text/javascript">
            $('.the-icons li').on('click', function(evt){
                ...
                var app = "";
                app += '<div class="control-group">';
                app += ' <label class="control-label" for="inputIcon">un label '+cls.replace('icon-', '')+': </label>';
                app += ' <div class="controls">';
