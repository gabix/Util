<?php
require_once '..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'miLib'.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'init.php';
...
function redirect() {
    ...
    header("location: ".APP_URL_ROOT. "Escribite/fully.php?nom=$entNom");
    exit();
}
