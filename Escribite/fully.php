<?php
require_once '..'.DIRECTORY_SEPARATOR.'miLib'.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'init.php';
...
<div class="d_superEnt">
    ...
    <a href="proc/p_blogEntrada.php?nom=<?= $selEnt->get('nombre') ?>&accion=eliminar-restaurar" class="btn">
